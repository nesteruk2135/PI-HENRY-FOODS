...
function rootReducer (state=initialState, action) {
    switch(action.type) {
       ...
       var typeDietFilter = action.payload === 'All' ? allRec : allRec.filter(t => t.typeDiets.find(e =>  e.name  === action.payload ) )  
        if(action.payload==='raros'){
             typeDietFilter= allRec.filter(t=>t.typeDiets.find(e=>e.name==='ketogenic'||e.name==='vegetarian'))
        }
