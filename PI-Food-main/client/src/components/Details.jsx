  ...
  return (
     ...
     { 
       ...
       <div className={styles.dt}> 
           ...
           <img className={styles.imga} src={detailsstate[0].img ? detailsstate[0].img :'https://st.depositphotos.com/1036708/2191/i/600/depositphotos_21918797-stock-photo-knife-and-fork-with-plate.jpg'} alt ='img not found'/>
